    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_oracion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contactos', to='grupo_oracion.grupodeoracion')),
            ],
        ),
    ]
